...
export class CreateConversationEntity1759211694508
  implements MigrationInterface
{
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "messages" ADD "conversationId" character varying NOT NULL`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "messages" ALTER COLUMN "customerId" DROP NOT NULL`,
    );
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "messages" ALTER COLUMN "customerId" SET NOT NULL`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "conversations" DROP CONSTRAINT "FK_conversations_customer"`,
    );
    await queryRunner.query(
      `ALTER TABLE "conversations" DROP CONSTRAINT "FK_conversations_tenant"`,
    );
