...
export const twilioConfig = registerAs('twilio', () => ({
  ...
  whatsapp: {
    ...
    webhookUrl: process.env.TWILIO_WHATSAPP_WEBHOOK_URL || '/api/v1/webhooks/twilio/whatsapp',
    statusCallbackUrl: process.env.TWILIO_WHATSAPP_STATUS_CALLBACK_URL || '/api/v1/webhooks/twilio/whatsapp/status',
    maxMessageLength: parseInt(process.env.TWILIO_WHATSAPP_MAX_MESSAGE_LENGTH, 10) || 1600,
    mediaSupport: {
  ...
  sms: {
    ...
    webhookUrl: process.env.TWILIO_SMS_WEBHOOK_URL || '/api/v1/webhooks/twilio/sms',
    statusCallbackUrl: process.env.TWILIO_SMS_STATUS_CALLBACK_URL || '/api/v1/webhooks/twilio/sms/status',
    maxMessageLength: parseInt(process.env.TWILIO_SMS_MAX_MESSAGE_LENGTH, 10) || 1600,
  ...
  voice: {
    ...
    webhookUrl: process.env.TWILIO_VOICE_WEBHOOK_URL || '/api/v1/webhooks/twilio/voice',
    statusCallbackUrl: process.env.TWILIO_VOICE_STATUS_CALLBACK_URL || '/api/v1/webhooks/twilio/voice/status',
    recordCalls: process.env.TWILIO_VOICE_RECORD_CALLS === 'true',
    transcribeRecordings: process.env.TWILIO_VOICE_TRANSCRIBE_RECORDINGS === 'true',
  },
  
  // Video configuration
  video: {
    enabled: process.env.TWILIO_VIDEO_ENABLED === 'true',
    webhookUrl: process.env.TWILIO_VIDEO_WEBHOOK_URL || '/api/v1/webhooks/twilio/video',
    statusCallbackUrl: process.env.TWILIO_VIDEO_STATUS_CALLBACK_URL || '/api/v1/webhooks/twilio/video/status',
  ...
  chat: {
    ...
    webhookUrl: process.env.TWILIO_CHAT_WEBHOOK_URL || '/api/v1/webhooks/twilio/chat',
  },
  ...
  messagingService: {
    ...
    useAlphanumericSender: process.env.TWILIO_USE_ALPHANUMERIC_SENDER === 'true',
  ...
  // Webhook security
  webhooks: {
    validateSignature: process.env.TWILIO_VALIDATE_WEBHOOK_SIGNATURE !== 'false',
    authToken: process.env.TWILIO_WEBHOOK_AUTH_TOKEN || process.env.TWILIO_AUTH_TOKEN,
  ...
  rateLimit: {
    ...
    messagesPerSecond: parseInt(process.env.TWILIO_MESSAGES_PER_SECOND, 10) || 1,
    messagesPerMinute: parseInt(process.env.TWILIO_MESSAGES_PER_MINUTE, 10) || 60,
  ...
  testing: {
    ...
    testNumbers: process.env.TWILIO_TEST_NUMBERS ? 
      process.env.TWILIO_TEST_NUMBERS.split(',') : ['+15005550006'],
