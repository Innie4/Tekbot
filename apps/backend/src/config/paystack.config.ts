...
export const paystackConfig = registerAs('paystack', () => ({
  ...
  supportedCurrencies: process.env.PAYSTACK_SUPPORTED_CURRENCIES ? 
    process.env.PAYSTACK_SUPPORTED_CURRENCIES.split(',') : ['NGN', 'USD', 'GHS', 'ZAR', 'KES'],
  ...
  transactions: {
    ...
    transactionCharge: parseInt(process.env.PAYSTACK_TRANSACTION_CHARGE, 10) || 0,
  },
  ...
  webhooks: {
    ...
    endpoints: {
      charge: process.env.PAYSTACK_WEBHOOK_CHARGE_ENDPOINT || '/api/v1/webhooks/paystack/charge',
      transfer: process.env.PAYSTACK_WEBHOOK_TRANSFER_ENDPOINT || '/api/v1/webhooks/paystack/transfer',
      subscription: process.env.PAYSTACK_WEBHOOK_SUBSCRIPTION_ENDPOINT || '/api/v1/webhooks/paystack/subscription',
      invoice: process.env.PAYSTACK_WEBHOOK_INVOICE_ENDPOINT || '/api/v1/webhooks/paystack/invoice',
    },
  ...
  transfers: {
    ...
    reason: process.env.PAYSTACK_TRANSFER_REASON || 'Payout from TekBot Platform',
  ...
  refunds: {
    ...
    merchantNote: process.env.PAYSTACK_REFUND_MERCHANT_NOTE || 'Refund processed by TekBot Platform',
    customerNote: process.env.PAYSTACK_REFUND_CUSTOMER_NOTE || 'Your refund has been processed',
  },
